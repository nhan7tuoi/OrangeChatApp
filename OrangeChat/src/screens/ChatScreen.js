                ...
                <ImageBackground
                    ...
                    >
                        ...
                        {messages.map((item, index) => {
                            ...
                            if (item.type === 'image' && (item.deleteBy?.length == 0 ||
                                item.deleteBy?.find(f => f !== user._id))) {
                                return (
                                    <ImageMessage
                                        key={index}
                            ...
                            if (item.type === 'file' && (item.deleteBy?.length == 0 ||
                                item.deleteBy?.find(f => f !== user._id))) {
                                return (
                                    <FileMessage
                                        key={index}
                            ...
                            if (item.type === 'video' && (item.deleteBy?.length == 0 ||
                                item.deleteBy?.find(f => f !== user._id))) {
                                return (
                                    <VideoMessage
                                        key={index}
                            ...
                            if (item.type === 'sticker' && (item.deleteBy?.length == 0 ||
                                item.deleteBy?.find(f => f !== user._id))) {
                                return (
                                    <StickerMessage
                                        key={index}
